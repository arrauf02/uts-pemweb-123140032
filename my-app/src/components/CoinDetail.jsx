  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <h4 style={{marginBottom: '10px'}}>Performa Kunci (24h & ATH)</h4>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', fontSize: '0.9em' }}>
            <div>
            ...
            <div>
                ...
                <strong>Low 24h:</strong> {formatCurrency(low_24h)}
            </div>

            <div style={{ borderLeft: '1px solid #eee', paddingLeft: '20px' }}>
                <strong>All Time High (ATH):</strong> {formatCurrency(ath)}<br/>
                <strong>Tanggal ATH:</strong> {new Date(ath_date).toLocaleDateString()}<br/>
            </div>
        </div>
